...
<h3 class="text-warning"><center><font size="10">Welcome Admin</font></center></h3>
...
<div class="container">
	<div class="col-lg-12"><br>
        ...
        <a href="insert.php" class="col-sm"><button class="btn btn-success col-sm">Add Employee</button></a>
        <a href="assign.php" class="col-sm"><button class="btn btn-success col-sm">Assign project</button></a>
        <a href="addproject.php" class="col-sm"><button class="btn btn-success col-sm" >Add Project</button></a>
    </div><br>
